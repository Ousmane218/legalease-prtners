    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          ...
          <span className="text-[9px] tracking-[0.28em] uppercase text-[#111111]/60 font-sans-ui -mt-0.5">
            {t('nav.subtitle')}
          </span>
        </a>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="group relative inline-flex items-center justify-center px-4 sm:px-5 py-2 text-xs font-medium tracking-widest uppercase text-[#111111] border border-[#111111] rounded-full hover:bg-[#111111] hover:text-[#F9F9F6] transition-all duration-200 focus:outline-none cursor-pointer"
          >
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center px-4 py-2.5 text-xs font-medium tracking-widest uppercase text-white bg-[#111111] rounded-full"
                >
                  <span>{t('nav.book')}</span>
