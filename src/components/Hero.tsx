    ...
    >
      ...
      <div className="max-w-5xl mx-auto w-full text-center mb-4 sm:mb-6">
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full border border-[#B6966B]/40 bg-[#B6966B]/5 text-[#B6966B] text-[11px] font-mono tracking-widest uppercase mb-4"
        >
        ...
        <motion.h1
          ...
          className="font-serif-title text-3xl sm:text-5xl md:text-6xl lg:text-[4rem] font-semibold text-[#111111] uppercase tracking-wide leading-[1.08] sm:leading-[1.1] max-w-5xl mx-auto"
        >
        ...
        >
          <button
            ...
            className="group inline-flex items-center justify-center px-7 sm:px-8 py-3.5 text-xs sm:text-sm font-medium tracking-widest uppercase text-[#F9F9F6] bg-[#111111] rounded-full hover:bg-[#0D0D0C] hover:ring-2 hover:ring-[#C5A880] transition-all duration-200 shadow-md cursor-pointer"
          >
      ...
      >
        ...
        {/* Right side: Three minimalist badges styled in borders */}
        <div className="md:col-span-5 flex flex-wrap items-center justify-start md:justify-end gap-2.5">
          <span className="px-3 py-1.5 text-[11px] font-mono tracking-widest uppercase border border-[#111111]/25 bg-[#111111]/[0.02] text-[#111111] rounded-none hover:border-[#B6966B] transition-colors">
            [ SÉNÉGAL ]
          </span>
          <span className="px-3 py-1.5 text-[11px] font-mono tracking-widest uppercase border border-[#111111]/25 bg-[#111111]/[0.02] text-[#111111] rounded-none hover:border-[#B6966B] transition-colors">
            [ DROIT OHADA ]
